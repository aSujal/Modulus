...
export default function NavLink({
    ...
    return (
        <Link
            {...props}
            className={
                'inline-flex rounded items-center border-none px-1 pt-1  font-medium leading-5 transition duration-150 ease-in-out focus:outline-none ' +
                (active
                    ? 'bg-[#dff9e0] text-gray-900 dark:border-indigo-600 dark:text-gray-100 '
